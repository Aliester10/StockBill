  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-brand">
        ...
        <span className="sidebar-label">SOA Generator</span>
      </div>
      ...
      <div className="sidebar-graphic">
        <div className="sidebar-graphic-inner">
          ...
          <div className="sg-circle sg-circle-1"></div>
          <div className="sg-circle sg-circle-2"></div>
        </div>
      </div>
